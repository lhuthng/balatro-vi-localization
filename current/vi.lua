return {
	descriptions={
		...
		Joker={
			...
			j_certificate={
				...
				text={
					...
					"với một {C:attention}dấu ấn{} ngẫu hiên ",
					"và đặt nó lên tay",
				},
				unlock={
					"Sở hữu một lá bài Vàng",
					"được đóng dấu bởi",
					"một {C:attention,E:1}Ấn Vàng",
				},
			},
			j_chaos={
			...
			j_faceless={
				name="Joker Vô Diện",
				text={
					"Nhận {C:money}$#1#{} nếu có từ {C:attention}#2#{}",
		...
		Spectral={
			...
			c_aura={
				name="Aura",
				text={
					"Add {C:dark_edition}In Nổi{}, {C:dark_edition}In Ba Chiều{},",
					"or {C:dark_edition}In Đa sắc{} effect to",
			...
			c_hex={
				name="Yểm Chú",
				text={
					"Gắn phiên bản {C:dark_edition}Đa Sắc{} vào",
					"một lá {C:attention}Joker{} bất kỳ đồng thời",
		...
		Tag={
			...
			tag_d_six={
				...
				text={
					...
					"tiếp theo bắt đầu với {C:money}$0",
				},
			},
			tag_double={
			...
			tag_garbage={
				name="Nhãn Tái Chế",
				text={
					"Được trả {C:money}$#1#{} mỗi {C:red}lượt bỏ{} ",
			...
			tag_voucher={
				...
				text={
					"Thêm một {C:voucher}Phiếu Khuyến Mãi",
		...
		Tarot={
			...
			c_wheel_of_fortune={
				...
				text={
					...
					"sẽ gắn một trong các phiên bản sau",
					"vào 1 lá {C:attention}Joker bất kỳ:",
		...
		Voucher={
			...
			v_illusion={
				...
				text={
					...
					"{C:dark_edition}Phiên Bản{}, và/hoặc một {C:attention}Dấu Ấn{}",
				},
				unlock={
					"Mua tổng cộng",
			...
			v_liquidation={
				...
				unlock={
					"Lĩnh ít nhất",
					"{C:attention}#1#{C:voucher} Phiếu Khuyến Mãi{}",
					"trong một trận",
				},
			},
			v_magic_trick={
	...
	misc={
		...
		dictionary={
			...
			b_stat_jokers="Bài Jokers",
			b_stat_planets="Bài hành tinh",
			b_stat_spectrals="Bài cô hồn",
			b_stat_tarots="Bài vận mệnh",
			b_stat_vouchers="Phiếu khuyến mãi",
			b_stats="Thông số",
			b_tags="Dấu nhãn",
			b_tarot_cards="Bài vận mệnh",
			b_unlock_all="Mở khoá tất cả",
			b_use="Sử dụng",
			b_vouchers="Phiếu khuyến mãi",
		...
		v_text={
			...
			ch_c_chips_dollar_cap={
				"{C:blue}Tổng phỉnh{} không được qua vượt qua {C:money}$",
			},
			ch_c_daily={
