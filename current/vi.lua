	...
	descriptions={
		...
		Edition={
			...
			e_negative_consumable={
				name="Âm Bản",
				text={
					"{C:dark_edition}+#1#{} chỗ lá tiêu hao",
				},
			},
			e_polychrome={
				name="In Đa sắc",
		...
		Joker={
			...
			j_bootstraps={
				...
				unlock={
					"Have at least {E:1,C:attention}#1#",
					"{C:dark_edition}In Đa sắc{} Jokers",
				},
			},
			j_brainstorm={
				name="Động Não",
			...
			j_todo_list={
				...
				text={
					"Nhận {C:money}$#1#{} nếu {C:attention}tay bài{}",
		...
		Tag={
			...
			tag_d_six={
				name="Nhãn Xuất Sắc/Xúc Sắc Sáu",
				text={
